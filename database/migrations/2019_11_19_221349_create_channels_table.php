...
class CreateChannelsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('channels', function (Blueprint $table) {
            ...
            $table->string('uri')->index()->nullable()->comment('uri路径英文名称');
            $table->unsignedBigInteger('pid')->index()->nullable()->default(0)->comment('父类ID，0为顶级分类');
            $table->unsignedBigInteger('channeltype_id')->nullable()->comment('类型');
            $table->unsignedBigInteger('sort')->index()->nullable()->default(0)->comment('排序');
            ...
            $table->unsignedTinyInteger('page')->index()->nullable()->default(10)->comment('分页');
