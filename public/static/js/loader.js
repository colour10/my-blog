...
(function(ba) {
    ...
    function C(b, c, d, e) {
        c = Error(c + "\nhttp://tbquirejs.org/docs/pages.html#" + b);
        c.tbquireType = b;
        c.tbquireModules = e;
        d && (c.originalError = d);
        return c
    ...
    function ga(b) {
        ...
        function d(a) { z && v(document.getElementsByTagName("script"), function(k) { if (k.getAttribute("data-tbquiremodule") === a && k.getAttribute("data-tbquirecontext") === i.contextName) return k.parentNode.removeChild(k), !0 }) }

        function e(a) { var k = m(j.paths, a); if (k && H(k) && 1 < k.length) return k.shift(), i.tbquire.undef(a), i.makeRequire(null, { skipMap: !0 })([a]), !0 }
        ...
        function p(a,
            ...
            a = a[1];
            e && (e = c(e, g, f), d = m(r, e));
            a && (e ? h = d && d.normalize ? d.normalize(a, function(a) { return c(a, g, f) }) : -1 === a.indexOf("!") ? c(a, g, f) : a : (h = c(a, g, f), a = n(h), e = a[0], h = a[1], b = !0, l = i.nameToUrl(h)));
        ...
        function w(a, b) {
            var c = a.tbquireModules,
                f = !1;
            if (b) b(a);
            else if (v(c, function(b) { if (b = m(h, b)) b.error = a, b.events.error && (f = !0, b.emit("error", a)) }), !f) g.onError(a)
        }
        ...
        var W, Z, i, L, X, j = { waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} },
            ...
            O = 1;
        L = {
            tbquire: function(a) { return a.tbquire ? a.tbquire : a.tbquire = i.makeRequire(a.map) },
        ...
        Z.prototype = {
                        ...
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (!this.defining) {
                                ...
                                if (1 > this.depCount && !this.defined) {
                                    if (G(l)) {
                                        if (this.events.error && this.map.isDefine || g.onError !== ca) try { f = i.execCb(c, l, b, f) } catch (d) { a = d } else f = i.execCb(c, l, b, f);
            ...
            callPlugin: function() {
                ...
                q(d, "defined", u(this, function(f) {
                    ...
                    } else d ? (this.map.url = i.nameToUrl(d), this.load()) : (l = u(this, function(a) { this.init([], function() { return a }, null, { enabled: !0 }) }), l.error = u(this, function(a) {
                        this.inited = !0;
                        this.error = a;
                        a.tbquireModules = [b];
            ...
            enable: function() {
                ...
                v(this.depMaps, u(this, function(a, b) {
                    ...
                    if ("string" === typeof a) {
                        ...
                        this.depMaps[b] = a;
                        if (c = m(L, a.id)) { this.depExports[b] = c(this); return }
                        this.depCount += 1;
        ...
        i = {
            ...
            configure: function(a) {
                ...
                B(h, function(a, b) {!a.inited && !a.map.unnormalized && (a.map = p(b)) });
            ...
            makeRequire: function(a, e) {
                ...
                U(j, {
                    ...
                    specified: function(b) { b = p(b, a, !1, !0).id; return t(r, b) || t(h, b) }
                });
    ...
    if ("undefined" === typeof define) {
        ...
        g({});
        v(["toUrl", "undef", "defined", "specified"], function(b) { g[b] = function() { var c = F._; return c.tbquire[b].apply(c, arguments) } });
        ...
        tbfine = function(b, c, d) {
            ...
            H(c) || (d = c, c = null);
            !c && G(d) && (c = [], d.length && (d.toString().replace(ka, "").replace(la, function(b, d) { c.push(d) }), c = (1 === d.length ? ["tbquire"] : ["tbquire", "exports", "module"]).concat(c)));
            if (M) {
                if (!(e = J)) N && "interactive" === N.readyState || T(document.getElementsByTagName("script"), function(b) { if ("interactive" === b.readyState) return N = b }), e = N;
                e && (b ||
